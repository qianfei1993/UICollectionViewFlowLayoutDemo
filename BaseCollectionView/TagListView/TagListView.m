...
#import "TagCell.h"
#import "TagListViewFlowLayout.h"

@interface TagListView ()<UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic, strong) UICollectionView *collectionView;

@property (nonatomic, strong) UILabel *testLabel; // Used to calculate text height

@property (nonatomic, copy) TagListViewBlock selectedBlock;
...
- (void)didSelectItem:(TagListViewBlock)block {
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        TagListViewFlowLayout *layout = [[TagListViewFlowLayout alloc] init];
...
- (void)setTagItemSpacing:(CGFloat)tagItemSpacing {
    ...
    TagListViewFlowLayout *layout = (TagListViewFlowLayout *)self.collectionView.collectionViewLayout;

//
//  HorizontalScale1ViewController.m
...
@interface HorizontalScale1ViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation HorizontalScale1ViewController
...
-(TypeHorizontalScaleFlowLayout *)flowLayout1{
    if (!_flowLayout1) {
        _flowLayout1 = [[TypeHorizontalScaleFlowLayout alloc]initWithScrollDirection:UICollectionViewScrollDirectionVertical withItemSize:CGSizeMake(kScreenWidth-40, kScreenHeight-kNavBarHeight-40) withColumnSpacing:0 withRowSpacing:20 withEdgeInsets:UIEdgeInsetsMake(20, 20, 20, 20)];
    }
    return _flowLayout1;
}
- (TypeHorizontalScaleFlowLayout *)flowLayout2{
    if (!_flowLayout2) {
        _flowLayout2 = [[TypeHorizontalScaleFlowLayout alloc]initWithScrollDirection:UICollectionViewScrollDirectionVertical withItemSize:CGSizeMake(kScreenWidth-40, kScreenHeight-kNavBarHeight-80) withColumnSpacing:0 withRowSpacing:20 withEdgeInsets:UIEdgeInsetsMake(40, 20, 40, 20)];
    }
    return _flowLayout2;
}
/*

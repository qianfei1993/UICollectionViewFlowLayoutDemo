...
#import "TypeHorizontalOrderFlowLayout.h"
...
- (void)setupWithCollectionView{
    ...
    TypeHorizontalOrderFlowLayout *flowLayout = [[TypeHorizontalOrderFlowLayout alloc]initWithColumnOrRowCount:4 withColumnSpacing:10 withRowSpacing:20 withEdgeInsets:UIEdgeInsetsMake(20, 15, 20, 15)];

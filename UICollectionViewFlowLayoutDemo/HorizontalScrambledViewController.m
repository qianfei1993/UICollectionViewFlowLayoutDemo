...
- (void)setupWithCollectionView{
    ...
    TypeHorizontalScrambledFlowLayout *flowLayout = [[TypeHorizontalScrambledFlowLayout alloc]initWithColumnOrRowCount:3 withColumnSpacing:10 withRowSpacing:20 withEdgeInsets:UIEdgeInsetsMake(20, 15, 20, 15)];
